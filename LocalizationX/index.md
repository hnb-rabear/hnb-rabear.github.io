...
Copy the __Client ID__ and __Client Secret__, and paste them into the corresponding settings in the __Settings__
...
__For the example using Google Sheets, you can view the file__ [__here__](https://docs.google.com/spreadsheets/d/1GuKuexdBzW3S3aXDx6eusUEhB6kxPq4cXaa9SuhVJJ0/edit?usp=drive_link).
